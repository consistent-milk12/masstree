...
//!
//! Compares MassTree24 across various key patterns designed to stress different
...
//!
//! ```bash
//! cargo bench --bench range_masstree24_crit
//! cargo bench --bench range_masstree24_crit --features mimalloc
//! cargo bench --bench range_masstree24_crit -- --save-baseline main
//! cargo bench --bench range_masstree24_crit -- --baseline main
//! ```
//!
...
fn bench_17_hot_spot(c: &mut Criterion) {
    ...
    for threads in [1, 2, 3, 4, 5, 6] {
        ...
        group.bench_function(BenchmarkId::new("masstree24", threads), |b| {
            ...
            b.iter_with_setup(
                || Arc::new(setup_masstree24(&all_keys)),
                |tree| {
                    let barrier = Arc::new(Barrier::new(threads));
                    let handles: Vec<_> = (0..threads)
                        .map(|t| {
