//! Benchmarks: `RwLock<BTreeMap>` vs `MassTree15` (Light)
//!
...
//! Running:
//! ```bash
//! cargo bench --bench rwlock_btreemap_vs_masstree15_light
//! cargo bench --bench rwlock_btreemap_vs_masstree15_light --features mimalloc
//! ```
...
#[divan::bench_group(name = "01_point_get_uniform_64B", sample_count = 20)]
...
#[divan::bench_group(name = "02_point_get_zipf_64B", sample_count = 20)]
...
#[divan::bench_group(name = "03_mixed_uniform_90_10_64B", sample_count = 20)]
...
#[divan::bench_group(name = "03b_mixed_zipf_hotset_95_5_64B", sample_count = 20)]
mod mixed_zipf_hotset_95_5_64b {
    use super::*;

    const N_KEYS: usize = 100_000;
    const HOTSET: usize = 2_048;
    const OPS_PER_THREAD: usize = 25_000;
...
#[divan::bench_group(name = "04_range_scan_window_64B", sample_count = 20)]
...
#[divan::bench_group(name = "05_range_scan_window_with_writes_64B", sample_count = 20)]
mod range_scan_window_with_writes_64b {
    ...
    const WRITES_PER_WRITER: usize = 25_000;
...
#[divan::bench_group(name = "06_point_get_uniform_shared_prefix_64B", sample_count = 20)]
...
#[divan::bench_group(name = "07_mixed_90_10_shared_prefix_64B", sample_count = 20)]
